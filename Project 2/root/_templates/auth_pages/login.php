...
<div class="form login" id="form-contain">
    <div class="form-content">
        ...
        <div class="form-link">
            <span>Don't have an account? <a href="<?=get_config('root_path');?>signup.php" class="link signup-link">Signup</a></span>
        </div>
    </div>
    ...
    <div class="media-options">
        <a href="#" class="field google">
            <svg class="google-img" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 512 512">
